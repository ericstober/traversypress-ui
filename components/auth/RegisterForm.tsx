            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className='bg-slate-100 dark:bg-slate-500 border-0 text-black dark:text-white focus-visible:ring-0 focus-visible:ring-offset-0' placeholder='Enter Name' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input className='bg-slate-100 dark:bg-slate-500 border-0 text-black dark:text-white focus-visible:ring-0 focus-visible:ring-offset-0' placeholder='Enter Email' {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
